...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-bg-primary transition-colors duration-300">
      <Navbar />

      {/* ═══════════════════════════════════════════
          HERO SECTION
          ═══════════════════════════════════════════ */}
      <section ref={heroRef} className="relative min-h-screen w-full overflow-hidden bg-bg-primary">
        {/* ── Large orange-to-transparent gradient sweep ── */}
        <div className="absolute top-0 right-0 w-[70%] h-[80%] pointer-events-none opacity-30 dark:opacity-20"
          style={{ background: 'linear-gradient(220deg, rgba(241,90,36,0.15) 0%, rgba(241,90,36,0.05) 30%, transparent 60%)' }} />
        <div className="absolute bottom-0 left-0 w-[60%] h-[50%] pointer-events-none opacity-20 dark:opacity-10"
          style={{ background: 'linear-gradient(40deg, rgba(241,90,36,0.1) 0%, transparent 50%)' }} />
        ...
        <div className="absolute top-10 left-[15%] w-[200px] h-[200px] rounded-full bg-orange-200/20 blur-[80px] pointer-events-none" />
        <div className="absolute top-[40%] left-[5%] w-[300px] h-[300px] rounded-full bg-orange-100/30 blur-[100px] pointer-events-none" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-8">
            ...
            <div className="flex-1 max-w-2xl">
              ...
              <motion.h1 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.1 }}
                className="font-display text-6xl md:text-8xl lg:text-[6.5rem] font-bold text-text-primary leading-[0.9] tracking-tight mb-8">
                Predict{' '}
                ...
                <br />
                <span className="text-text-muted font-light italic text-[0.6em]">with</span>{' '}
                DNA.
              </motion.h1>

              <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }}
                className="text-lg md:text-xl text-text-secondary max-w-lg mb-10 leading-relaxed font-light">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.5 }}
                ...
                <button className="flex items-center gap-2 px-6 py-4 text-sm font-semibold text-text-secondary hover:text-brand-orange transition-colors group">
                  <div className="w-10 h-10 rounded-full border-2 border-border-main flex items-center justify-center group-hover:border-brand-orange transition-colors">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div animate={{ y: [0, -8, 0] }} transition={{ duration: 5, repeat: Infinity }}
                ...
                <div className="flex items-center gap-3 bg-bg-primary border border-border-main rounded-2xl px-4 py-3 shadow-lg">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-text-primary">MDR K. pneumoniae detected</div>
                  </div>
                </div>
              </motion.div>

              {/* ─── Floating Card: Resistance Trend ─── */}
              <motion.div animate={{ y: [0, 6, 0] }} transition={{ duration: 6, repeat: Infinity, delay: 0.5 }}
                ...
                <div className="bg-bg-primary border border-border-main rounded-2xl px-5 py-4 shadow-lg w-[180px]">
                  <div className="text-[10px] text-text-muted uppercase tracking-wider font-medium mb-1">Resistance Rate</div>
                  ...
                  <div className="flex items-end gap-[3px] h-10">
                    {[40, 55, 35, 60, 45, 70, 50, 80, 65, 90, 75, 95].map((h, i) => (
                      <motion.div key={i}
                        ...
                        className={`flex-1 rounded-sm ${i >= 10 ? 'bg-brand-orange' : 'bg-bg-tertiary'}`}
                      />
                    ))}
                  </div>
                  <div className="flex items-center gap-1 mt-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-brand-orange" />
                    <span className="text-[9px] text-text-muted">Jan — Jun 2026 · AI-tracked</span>
                  </div>
                </div>
              </motion.div>
              ...
              <div className="relative z-10 w-[280px] md:w-[300px] mt-16">
                <div className="bg-bg-primary border border-border-main rounded-2xl overflow-hidden shadow-2xl shadow-black/5 dark:shadow-orange-500/5">
                  {/* Window chrome */}
                  <div className="flex items-center gap-4 px-4 py-3 border-b border-border-main bg-bg-secondary/60">
                    <div className="flex gap-1.5">
                      <div className="w-2.5 h-2.5 rounded-full bg-red-400" />
                      <div className="w-2.5 h-2.5 rounded-full bg-yellow-400" />
                      <div className="w-2.5 h-2.5 rounded-full bg-green-400" />
                    </div>
                    <span className="text-[10px] text-text-muted font-mono">zenthera.ai · dashboard</span>
                  </div>

                  <div className="p-5">
                    <div className="text-[10px] text-text-muted uppercase tracking-wider font-semibold mb-1">Pipeline Accuracy</div>
                    <div className="flex items-baseline gap-3 mb-5">
                      <span className="text-4xl font-bold text-text-primary font-display">98<span className="text-xl">%</span></span>
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={row.code} className="flex items-center gap-3 bg-bg-secondary rounded-xl px-3 py-2.5">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-[10px] text-text-muted">{row.detail}</div>
                          </div>
                          <span className="text-sm font-bold text-text-muted">{row.score}</span>
                        </div>
                      ))}
                    </div>

                    <div className="mt-5 flex items-center justify-between mb-2">
                      <span className="text-[10px] text-text-muted uppercase tracking-wider">Weekly target</span>
                      <span className="text-xs font-bold text-text-secondary">78%</span>
                    </div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5 }}
          ...
          <motion.div animate={{ y: [0, 8, 0] }} transition={{ duration: 1.5, repeat: Infinity }}
            className="w-5 h-8 border-2 border-border-main rounded-full flex justify-center pt-1.5">
      ...
      {/* ═══════════════════════════════════════════
          ABOUT / INTRO SECTION
          ═══════════════════════════════════════════ */}
      <section id="section-about" className="relative py-32 md:py-40 bg-bg-primary overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <Reveal>
              <div>
                ...
                <h2 className="font-display text-5xl md:text-6xl font-bold text-text-primary leading-tight mb-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {['CARD Database', 'Mutation Detection', 'K-mer Analysis', 'Ensemble ML'].map((tag) => (
                    <span key={tag} className="px-4 py-2 bg-bg-secondary border border-border-main rounded-full text-xs font-semibold text-text-secondary uppercase tracking-wider">{tag}</span>
                  ))}
                </div>
              </div>
            </Reveal>
            <Reveal delay={0.2}>
              <div className="relative">
                <div className="absolute -inset-8 bg-gradient-to-br from-brand-orange/10 to-orange-50/50 rounded-[3rem] blur-2xl opacity-60" />
                <div className="relative bg-bg-primary rounded-[2.5rem] border border-border-main shadow-2xl p-10 aspect-square flex items-center justify-center overflow-hidden">
                  ...
                  <div className="absolute bottom-8 left-8 right-8 bg-bg-primary/90 backdrop-blur-md rounded-2xl p-5 border border-border-main shadow-lg">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-8 h-8 bg-brand-orange rounded-lg flex items-center justify-center">
                        <Dna className="w-4 h-4 text-white" />
                      </div>
                      <span className="text-sm font-bold text-text-primary">Genome Analysis</span>
                    </div>
                    <div className="w-full h-2 bg-bg-tertiary rounded-full overflow-hidden">
                      <motion.div initial={{ width: 0 }} whileInView={{ width: '85%' }} transition={{ duration: 2, ease: 'easeOut' }}
                        className="h-full bg-gradient-to-r from-brand-orange to-brand-orange-light rounded-full" />
                    </div>
                    <div className="text-[10px] text-text-muted mt-2 font-mono tracking-wider">PROCESSING K-MERS...</div>
                  </div>
                </div>
              </div>
            </Reveal>
            ...
            {features.map((f, i) => (
              <Reveal key={i} delay={i * 0.08}>
                <motion.div whileHover={{ y: -8 }} transition={{ type: 'spring', stiffness: 300 }}
                  className="group bg-bg-primary p-8 rounded-3xl border border-border-main shadow-sm hover:shadow-xl hover:border-brand-orange/30 transition-all cursor-pointer h-full">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-text-muted bg-bg-tertiary px-3 py-1 rounded-full">{f.tag}</span>
                  </div>
      ...
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      <section className="relative py-32 md:py-40 bg-bg-secondary overflow-hidden border-y border-border-main">
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            ...
            <Reveal delay={0.2}>
              <p className="text-text-secondary text-lg max-w-sm font-light leading-relaxed">Four steps from raw genomic data to actionable clinical intelligence.</p>
            </Reveal>
          </div>
            ...
            {steps.map((s, i) => (
              <Reveal key={i} delay={i * 0.12}>
                <div className="relative group">
                  <div className="w-16 h-16 bg-bg-primary border border-border-main rounded-2xl flex items-center justify-center mb-8 group-hover:border-brand-orange/50 group-hover:bg-brand-orange/10 transition-all shadow-sm">
      ...
      <section className="relative py-32 bg-bg-primary overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 text-center">
          <Reveal>
            ...
            <h2 className="font-display text-5xl md:text-7xl font-bold text-text-primary mb-8 leading-tight">
              Start predicting<br />resistance <span className="text-brand-orange">today</span>
            </h2>
            <p className="text-xl text-text-secondary max-w-xl mx-auto mb-12 font-light leading-relaxed">
      ...
      {/* ═══════════════════════════════════════════
          FOOTER
          ═══════════════════════════════════════════ */}
      <footer className="bg-bg-secondary text-text-primary border-t border-border-main pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-4 gap-16 mb-20">
            <div className="md:col-span-2">
              ...
              <p className="text-text-secondary text-base max-w-sm leading-relaxed font-light">
                Empowering clinical diagnostics with predictive AI and high-performance computational biology.
              </p>
            </div>
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-text-muted mb-6">Platform</h4>
            ...
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-text-muted mb-6">Company</h4>
              <ul className="space-y-4 text-text-secondary text-sm font-medium">
          ...
          <div className="pt-8 border-t border-border-main flex flex-col md:flex-row justify-between items-center text-xs text-text-muted gap-4">
